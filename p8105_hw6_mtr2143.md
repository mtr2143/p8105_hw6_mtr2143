...
log_b0_b1_plot <-
  boot_straps %>% 
    ...
    geom_density() +
    xlab("Log of Product of Estimated Slope and Intercept") + ylab("Density")
...
estimate appears to be around 0.91, and the center for the log of the
product of the estimated slope and intercept appears to be around 2.01.
...
ci_df %>% 
  knitr::kable(
    digits = 3,
    caption = "95% Confidence Intervals for R-Squared and Log of Product of Estimated Slope and Intercept"
  )
```
...
95% Confidence Intervals for R-Squared and Log of Product of Estimated
Slope and Intercept
